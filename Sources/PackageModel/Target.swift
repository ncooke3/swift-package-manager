...
public final class MixedTarget: Target {
    ...
    // MARK: Swift-specific Properties

    /// The swift version of this target.
    public let swiftVersion: SwiftLanguageVersion

    // MARK: C-specific Properties
    ...
    private enum CodingKeys: String, CodingKey {
        case swiftVersion, includeDir, moduleMapType, headers, isCXX, cLanguageStandard, cxxLanguageStandard
    }
